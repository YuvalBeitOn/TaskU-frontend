<template>
  <section class="upload-image-container">
       ...
       <div class="container-img flex align-center" v-if="!isLoading">
           <slot name="imgUrl">
             <img 
                    class="img-uploaded"
            v-if="imgUrl"
          ...
          />
            ...
            <div  v-tooltip.top="'Upload Image'" class="btn-close white btn-upload-container"> 
                 <slot name="btn-upload"><i class="upload-img fas fa-cloud-upload-alt"></i></slot>
            </div>
